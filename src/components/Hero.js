...
export default function Hero() {
  ...
  return (
    ...
    <div className="bg-lord-vishnu bg-cover object-contain bg-center bg-opacity-25">
      <main>
        <div className="relative px-6 lg:px-8">
          <div className="mx-auto max-w-3xl pt-20 pb-32 sm:pt-28 sm:pb-30">
            <div>
              <div>
                <h1 className="text-4xl font-bold tracking-tight sm:text-center sm:text-6xl">
                  Welcome to <br/> Vishnu Boys' Hindu College
                </h1>
                <p className="mt-6 text-lg leading-8  text-slate-700  sm:text-center">
